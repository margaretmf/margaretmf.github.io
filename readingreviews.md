...
The author's negative sentiment that it is late for regulators to step in and that their approach has not been proactive makes sense; but technology companies expect to build bigger, more expansive tools that may create even more risk  over the next ten years, so it is imperative that regulators do thoughtful work now. Swisher fails to mention the work that groups likes [Aspen Technology Policy Hub](https://www.aspentechpolicyhub.org/#/) and [The Bridge](https://thebridgework.com/) have coordinated to connect policy makers, regulators, and technologists. Potential for creative collaboration and positive solutions lies ahead given the thought from these groups and resonates with the author's last paragraph:
