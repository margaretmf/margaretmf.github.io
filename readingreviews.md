...
On June 4, 2019, Kara Swisher wrote an opinion article on how regulators did not care at all about what technology companies did with sloppy management of data and infrastructure a few years ago, but now they enter into the scene with legal pads and regulatory concerns in thoughtless, haphazard ways to address concerns regarding privacy and security. This article reveals how little regulators and technologists have spent thoughtfully working with each other. Swisher claims that while she agrees that America must regulate technology, self-interest drives the current efforts, making them haphazard and reactive; and warning signs of "rampant disinformation, egregious privacy breaches and in-plain-sight addictive elements built right into the medium" existed a decade ago, but the two groups of people did not work together effectively.

I agree with the author's negative sentiment that it is late for regulators to step in and that their approach has not been proactive; but technology companies expect to build bigger, more expansive tools that may create even more risk  over the next ten years, so it is imperative that regulators do thoughtful work now. Swisher fails to mention the work that groups likes [Aspen Technology Policy Hub](https://www.aspentechpolicyhub.org/#/) and [The Bridge](https://thebridgework.com/) have coordinated to connect policy makers, regulators, and technologists. Potential for creative collaboration and positive solutions lies ahead given the thought from these groups and resonates with the author's last paragraph:
